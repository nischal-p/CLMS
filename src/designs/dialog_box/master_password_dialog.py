...
class MasterPasswordDialog:
    ...
    def retranslateUi(self):
        self.this_dialog.setWindowTitle(_translate("dialog1", "Enter Master Password", None))
        self.master_password_label.setText(_translate("dialog1", "Enter the library master password:", None))
