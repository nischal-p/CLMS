...
from designs.after_login.after_login_window import AfterLoginWindow
...
class FirstWindow:
    ...
    def login_clicked(self):
        ...
        password_in_database = StaffDAO.get_password(input_email)
        if password_in_database is not None:
            ...
            if password_match:
                ...
                self.show_after_login_window(input_email)
            else:
    ...
    def show_after_login_window(self, staff_logging_in):
        self.after_login_window = QtGui.QMainWindow()
        self.after_login_window_ui = AfterLoginWindow(self.after_login_window, staff_logging_in)
